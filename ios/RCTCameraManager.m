...
RCT_EXPORT_METHOD(prepareForMontage:(NSDictionary *)options
                  resolve:(RCTPromiseResolveBlock)resolve
                  reject:(RCTPromiseRejectBlock)reject) {
    NSInteger captureMode = [[options valueForKey:@"mode"] intValue];
    NSInteger captureTarget = [[options valueForKey:@"target"] intValue];
...
RCT_EXPORT_METHOD(lockMontage:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    AVCaptureDevice *device = [self.videoCaptureDeviceInput device];
    NSError *error = nil;
    if ([device lockForConfiguration:&error])
    {
...
RCT_EXPORT_METHOD(openMontage:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject) {
    AVCaptureDevice *device = [self.videoCaptureDeviceInput device];
    NSError *error = nil;
    if ([device lockForConfiguration:&error])
    {
